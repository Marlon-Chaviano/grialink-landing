export default {
  ...
  kanban: {
    iaImpact: 'AI Impact',
    iaImpactValue: '+$12k',
    iaImpactDesc: 'Extra generated this month with automation',
    col1Title: 'New Leads',
    lead1Name: 'Maria Johnson',
    lead1Tag: 'Facial aesthetics',
    lead2Name: 'Charles Davis',
    lead2Tag: 'Dental implant',
    col2Title: 'Contacted',
    lead3Name: 'Anna Martinez',
    lead3Msg: 'Replied on WhatsApp: "I\'m interested in the quote"',
    lead3Btn: 'Schedule appointment',
    col3Title: 'Scheduled',
  },
};
