export default {
  ...
  kanban: {
    iaImpact: 'Impacto IA',
    iaImpactValue: '+$12k',
    iaImpactDesc: 'Generados extra este mes con automatización',
    col1Title: 'Nuevos Leads',
    lead1Name: 'María González',
    lead1Tag: 'Estética facial',
    lead2Name: 'Carlos Ruiz',
    lead2Tag: 'Implante dental',
    col2Title: 'Contactados',
    lead3Name: 'Ana Martínez',
    lead3Msg: 'Respondió por WhatsApp: "Me interesa el presupuesto"',
    lead3Btn: 'Agendar cita',
    col3Title: 'Cita agendada',
  },
};
