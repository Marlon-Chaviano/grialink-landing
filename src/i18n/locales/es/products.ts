export default {
  ...
  products: [
    {
      title: 'Prospector AI',
      description: 'Encuentra leads potenciales con búsqueda inteligente en lenguaje natural. Enriquece datos automáticamente con Apollo.io e importa hasta 800 contactos/mes.',
      color: 'blue',
    },
    {
